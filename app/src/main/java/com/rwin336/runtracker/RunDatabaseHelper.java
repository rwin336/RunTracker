...
public class RunDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_LOCATOIN_RUN_ID = "run_id";
    ...
    public long insertLocation(long runId, Location location) {
        ...
        cv.put(COLUMN_LOCATOIN_RUN_ID, runId);
        Log.d(TAG, "Insert Run ID: " + runId + ", location from " + location.getProvider() + ": "
